...
export class FirstMigration1700621509920 implements MigrationInterface {
    name = 'FirstMigration1700621509920'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "created_by" character varying, "created_date" TIMESTAMP DEFAULT now(), "last_modified_by" character varying, "last_modified_date" TIMESTAMP DEFAULT now(), "name" character varying(30) NOT NULL, "email" character varying(40) NOT NULL, "password" character varying NOT NULL, "gender" "public"."user_gender_enum" NOT NULL, "verify_token" character varying, "reset_token" character varying, "role" "public"."user_role_enum" NOT NULL DEFAULT 'USER', "company_id" integer, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
